...
<p>We didn&rsquo;t have many knocks against this laptop, but the design is anything but a head-turner, that&rsquo;s for sure. If you can live with the ho-hum design, the Victus 16 is a solid choice, especially if you&rsquo;re on a strict budget.</p>
			...
			<div class="wp-block-product-chart-item product-chart-item">
						...
						<h3 class="product-chart-item__title-wrapper--title product-chart-title " id="alienware-x15-r2-best-high-end-option">
							...
							product-chart-item__image-outer-wrapper--large">
							<div class="product-chart-item__image-wrapper">
								<img alt="Alienware x15 R2 - Best high-end option" class="product-chart-item__image" height="3024" src="https://b2c-contenthub.com/wp-content/uploads/2022/07/Alienware-x15-R2.jpg?quality=50&amp;strip=all" width="4032" /></div>
						</div>
															<div class="product-chart-body">
						<div class="product-chart-columns">
...
<p>You may also want to consider Samsung&rsquo;s 980 Pro, which dominated the earliest PCIe 4.0 SSDs. It&rsquo;s since been surpassed by the performance of second-gen PCIe 4.0 drives, but the 980 Pro remains a compelling option, especially if you&rsquo;re looking for a lower-capacity SSD. Most PCIe 4.0 drives start at 1TB, but you&rsquo;ll find <a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.amazon.com/dp/B08GL52C3V?th=1&amp;xcust=2-2-394512-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">256GB</a> and <a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.amazon.com/dp/B08GL575DB?th=1&amp;xcust=2-2-394512-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">500GB</a> versions of the 980 Pro available for $80 and $110, respectively, in addition to beefier capacities. Samsung&rsquo;s superb &ldquo;Magician&rdquo; SSD management software and long five-year warranty remain second to none, as well.</p>
						</div>
											Read our full 
					<a class="product-chart-item__review-link" href="https://www.pcworld.com/article/393496/samsung-980-pro-nvme-ssd-review.html" target="_blank">Samsung 980 Pro PCIe 4 NVMe SSD (1TB) review</a>
								</div>
					</div>
...
<h2 id="what-to-look-for-in-an-ssd">What to look for in an SSD</h2>



<p>There are a few things to look out for, but most importantly you&rsquo;ll want to focus on capacity, price, and warranty length. Three-year warranties are standard, but some nicer models are guaranteed for up to five years. And unlike the olden days of SSDs, modern drives won&rsquo;t wear out with normal consumer usage, as <a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=http://techreport.com/review/27909/the-SSD-endurance-experiment-theyre-all-dead&amp;xcust=2-2-394512-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">Tech Report</a> tested and proved years ago with a grueling endurance test.</p>



<p>Another crucial thing to watch out for is the technology used to connect the SSD to your PC. For more details and buying advice you can read our in-depth guide on <a href="https://www.pcworld.com/article/3605356/what-type-of-ssd-should-you-buy.html">which type of SSD you should buy</a>.</p>



<ol class="productChart"><li><strong>SATA</strong>: This refers to both the connection type and the transfer protocol, which is used to connect most 2.5-inch and 3.5-inch hard drives and SSDs to your PC. SATA III speeds can hit roughly 600MBps, and most&mdash;but not all&mdash;modern drives max it out. (More on that in the next section.)</li><li><strong>PCIe</strong>: This interface taps into four of your computer&rsquo;s PCIe lanes to blow away SATA speeds, to the tune of nearly 4GBps over PCIe gen 3. Those sort of face-melting speeds pair nicely with supercharged NVMe drives. Both the PCIe lanes in your motherboard and the M.2 slot in your motherboard can be wired to support the PCIe interface, and you can buy adapters that allow you to slot &ldquo;gumstick&rdquo; M.2 drives into a PCIe lane. PCIe 4.0 drives are significantly faster, but require an AMD Ryzen 3000-series or Intel Core 11th-gen (or newer) processor, along with a compatible PCIe 4.0 motherboard.</li><li><strong>NVMe</strong>: Non-Volatile Memory Express technology takes advantage of PCIe&rsquo;s bountiful bandwidth to create blisteringly fast SSDs that blow SATA-based drives out of the water. Check out PCWorld&rsquo;s &ldquo;<a href="https://www.pcworld.com/article/2899351/everything-you-need-to-know-about-nvme.html">Everything you need to know about NVMe</a>&rdquo; for a nitty-gritty deep-dive.</li><li><strong>M.2</strong>: This is where things get tricky. Many people assume M.2 drives all use NVMe technology and PCIe speeds, but that&rsquo;s not true. M.2 is just a form factor. Sure, <em>most</em> M.2 SSDs use NVMe, but some still stick to SATA. Do your homework. Many modern Ultrabooks rely on M.2 for storage.</li><li><strong>U.2 and mSATA</strong>: You may also stumble across mSATA and U.2 SSDs, but both motherboard support and product availability are rare for those formats. Some older Ultrabooks included mSATA before M.2 became popular, and drives are still available if you need them.</li></ol><p>Speed matters, of course, but as we said most modern SSDs saturate the SATA III interface. Not all of them, though.</p>



<h2 id="how-we-test-ssds">How we test SSDs</h2>



<p>We test SSDs using a variety of synthetic benchmarks (such as CrystalDiskMark 6&rsquo;s various tests) and real-world tests, including 48GB transfers that showcase how a drive performs during common tasks, and also a demanding 450GB transfer test that pushes an SSD&rsquo;s cache performance to the limit. </p>



<p>The PCIe 4.0 testing was done on an MSI MEG X570 motherboard socketing an AMD Ryzen 7 3700X 8-core CPU, using the same Kingston DRAM, cards, and software. All testing is performed on an empty, or nearly empty drive. Note: performance will decrease as the drive fills up.</p>
Computer Components, Computer Storage Devices, Samsung Electronics, Seagate</div>
...
<p>A thousand bucks and change is still a lot of money for any monitor, but this model makes a compelling argument that it still counts as a value. It&rsquo;s the cheapest QD-OLED screen you can get designed for PC gaming (unless you find a deal on a smaller OLED TV), and with 165Hz of refresh rate, a claimed 0.1ms gray-to-gray refresh rate, and the usual 3440&times;1440 ultrawide resolution, it&rsquo;s packing the specs that a lot of gamers crave. Yes, it&rsquo;s nearly identical to the previous model, but this one comes clad in black plastic all over instead of the panda-ish look, with a somewhat gaudy &ldquo;34&rdquo; LED lighting up the rear. </p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="Alienware OLED monitor front and back" class="wp-image-1376908" height="476" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/aw3423dwf-cfp-01-bk-rgb.png?w=1200" width="1200" /></figure><p class="imageCredit">Dell</p></div>



<p>The shift from Nvidia to AMD branding for the refresh system probably won&rsquo;t matter too much &mdash; anyone planning to drop this much cash on a monitor can put out frames fast enough, and FreeSync works with Radeon and GeForce GPUs alike (unlike the Nvidia-only G-Sync). BConnections include two DisplayPort 1.4 ports, one HDMI 2.0 port, four USB 3.2 gen1 ports (two on the bottom bezel for easy access), and headphone jacks on the bottom and rear. It&rsquo;s a shame that there&rsquo;s still no USB-C option on a screen this expensive, though. </p>



<p>Gamers can go with the elaborate built-in stand or the usual 100x100mm VESA mount, but get one that&rsquo;s sturdy if you replace it &mdash; this thing is nearly 14 pounds for the screen alone. Along with refreshed Aurora desktops packing the <a href="https://www.pcworld.com/article/1348123/nvidia-geforce-rtx-4090-review-ada-lovelace.html">latest Nvidia RTX 4090 cards</a> and a new tenkeyless mechanical keyboard, <a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://dell.alienwarearena.com/alienware-upgrades-flagship-desktop-reveals-tenkeyless-keyboard-and-new-qd-oled-display/&amp;xcust=2-2-1376879-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">the AW3423DWF will launch &ldquo;later this fall.&rdquo;</a> </p>



		<div class="wp-block-product-widget-block product-widget">
			<div class="product-widget__block-title-wrapper">
				<h4 class="product-widget__block-title" id="alienwares-original-qd-oled-monitor-is-magical">
					alienware's original qd-oled monitor is magical				</h4>
			</div>
			...
			<div class="product-widget__content-wrapper">
				...
				<div class="product-widget__information">
								...
								<a class="product-widget__pricing-details--link" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.tkqlhce.com/click-8200811-13502820?url=https%3A%2F%2Fwww.dell.com%2Fen-us%2Fshop%2Falienware-34-curved-qd-oled-gaming-monitor-aw3423dw%2Fapd%2F210-bcye%2Fmonitors-monitor-accessories&amp;xcust=2-2-1376879-5-624338-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">$1199.99 at  Dell Home</a>											<span class="amp-bar"> | </span>
																		<a class="product-widget__pricing-details--link" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.tkqlhce.com/click-8200811-13513947?url=https%3A%2F%2Fwww.dell.com%2Fen-us%2Fshop%2Falienware-34-curved-qd-oled-gaming-monitor-aw3423dw%2Fapd%2F210-bcye%2Fmonitors-monitor-accessories&amp;xcust=2-2-1376879-5-624338-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">$1199.99 at  Dell Small Business</a>							</span>
						</div>
									</div>
			</div>
		</div>
...
<p>Spoiler alert: The GeForce RTX 4090&rsquo;s content creation performance is magical. In quite a few cases, the typically nonsense &ldquo;2X performance increase&rdquo; is actually true. But not everywhere.</p>
...
<ul><li>Intel Core i9-12900k CPU</li><li>32GB Corsair Vengeance DDR5 5200MT/s RAM</li><li>ASUS ROG STRIX Z690-E Gaming Wifi Motherboard</li><li>EVGA G3 850W PSU</li><li>Source files stored on a PCIe gen 4 NVMe SSD</li></ul><p>My objectives were to see how much of an upgrade the RTX 4090 would be over the previous generation <a href="https://www.pcworld.com/article/393531/nvidia-geforce-rtx-3090-founders-edition-review.html">GeForce RTX 3090</a>, as well as the RTX Titan (the card I was primarily working on before). The RTX 3090 really saw minimal improvements over the RTX Titan for my use cases, so I wasn&rsquo;t sure if the 4090 would really be a big leap. For some more hardcore testing later as I&rsquo;ll mention, testing was done on this test bench.</p>



<ul><li>AMD Threadripper Pro 3975WX CPU</li><li>256GB Kingston ECC DDR4 RAM</li><li>ASUS WRX80 SAGE Motherboard</li><li>BeQuiet 1400W PSU</li><li>Source files stored on a PCIe gen 4 NVMe SSD</li></ul><p>Each test featured each GPU in the same config as to not mix results.</p>
...
<p>My day job is, of course, creating YouTube content, so one of the first things I had to test would be the benefits I might see for creating video content. Using <a href="https://www.pugetsystems.com/labs/articles/PugetBench-for-Premiere-Pro-1519/">PugetBench</a> from the workstation builders at Puget Systems, Adobe Premiere Pro sees very minimal performance improvement with the RTX 4090 (as to be expected at this point).</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375923" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-PPRO-GPU.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375924" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-PPRO.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>BlackMagic DaVinci Resolve, however, saw <strong>significant</strong> performance improvements across the board over both the RTX 3090 and RTX Titan. This makes sense, as Resolve is far more optimized for GPU workflows than Premiere Pro. Renders were much faster thanks both to the higher 3D compute on effects, but also the faster encoding hardware onboard&mdash;and the general playback and workflow was much more &ldquo;snappier&rdquo; feeling and responsive.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375935" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-Resolve-GPU.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375939" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-RESOLVE.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>I&rsquo;ve been editing with the GeForce RTX 4090 for a few weeks now, and the experience has been great&mdash;though I had to revert back to the public release of Resolve so I haven&rsquo;t been able to export using the AV1 encoder for most of my videos.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375925" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-resolve-encode-speed.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>I also wanted to test to see if the AI hardware improvements would benefit Resolve&rsquo;s Magic Mask tool for rotoscoping, or their face tracker for the Face Refinement plugin. Admittedly, I was hoping to see more improvements from the RTX 4090 here, but there is <em>an improvement</em>, which saves me time and is a win. These tasks are tedious and slow, so any minutes I can shave off makes my life easier. Perhaps in time more optimization can be done specific to the new architecture changes in Lovelace (the RTX 40-series&rsquo; underlying GPU architecture codename).</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375926" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-Object-Mask.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375930" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-FaceTrack.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>The performance in my original Resolve benchmarks impressed me enough that I decided to build a second-tier test using my Threadripper Pro workstation; rendering and exporting a 8K video with 8K RAW source footage, lots of effects and Super Scale (Resolve&rsquo;s internal &ldquo;smart&rdquo; upscaler) on 4K footage, etc. This project is no joke, the normal high-tier gaming cards just errored out because their lower VRAM quantities couldn&rsquo;t handle the project&mdash; this bumps the RTX 3060, 2080, and 3080 out of the running. But putting the 24GB VRAM monsters to the test, the RTX 4090 exported the projects a whole 8 minutes faster than the test. <strong>Eight minutes.</strong> That kind of time scaling is game changing for single person workflows like mine.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375922" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-8k.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>If you&rsquo;re a high res or effect-heavy video editor, the RTX 4090 is already going to save you hours of waiting and slower working, right out of the gate and we haven&rsquo;t even talked about encoding speeds yet.</p>
...
<p>For simply transcoding video in H.264 and H.265, the GeForce RTX 4090 also just runs laps around previous Nvidia GPUs. H.265 is the only area where AMD out-performs Nvidia in encoder speed (though not necessarily quality) as ever since the Radeon 5000 GPUs, AMD&rsquo;s HEVC encoder has been blazing fast.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375929" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-handbrake-h264.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>The new Ada Lovelace architecture also comes with new dual encoder chips that individually already run a fair bit faster for H.264 and H.265 encoding than Ampere and Turing, but they also encode AV1&mdash;the new, open-source video codec from the Alliance for Open Media.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375927" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-handbrake-h265.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>AV1 is the future of web-streamed video, with most major companies involved in media streaming also being members of the consortium. The goal is to create a highly efficient (as in, better quality per bit) video codec that can meet the needs of the modern high resolution, high frame rate, and HDR streaming world, while avoiding the high licensing and patent costs associated with H.265 (HEVC) and H.266 codecs. Intel was first to market with hardware AV1 encoders with their Arc GPUs <a href="https://www.pcworld.com/article/827992/tested-intel-arc-av1-video-encoder-vs-nvidia-amd.html">as I covered for PCWorld here</a>&mdash;now Nvidia brings it to their GPUs.</p>



<p>I cannot get completely accurate quality comparisons between Intel and Nvidia&rsquo;s AV1 encoders yet due to limited software support. From the basic tests I could do, Nvidia&rsquo;s AV1 encodes are on par with Intel&rsquo;s&mdash;but I have since found out that the encoder implementations in even the software I <em>can</em> use them in both could use some fine-tuning to best represent both sides.</p>



<p>Performance-wise, AV1 performs about as fast as H.265/HEVC on the RTX 4090. Which is fine. But the new dual encoder chips allow both H.265 and AV1 to be used to encode 8K60 video, or just faster 4K60 video. They do this by splitting up the video frames into horizontal halves, encoding the halves on the separate chips, and then stitching back together before finalizing the stream. This sounds like how Intel&rsquo;s Hyper Encode was supposed to work&mdash;Hyper Encoder instead separating GOPs (Group of Pictures or frames) among the iGPU and dGPU with Arc&mdash;but in all of my tests, I only found Hyper Encode to slow down the process, rather than speeding it up. (Plus it didn&rsquo;t work with AV1.)</p>
...
<p>As a result of the aforementioned improvements in encoder speed, streaming and recording your screen, camera, or gameplay is a far, far better experience. This comes with an update to the NVENC encoder SDK within OBS Studio, now presenting users with 7 presets (akin to X264&rsquo;s &ldquo;CPU Usage Presets&rdquo;) scaling from P1 being the fastest/lowest quality to P7 being the slowest/best quality. In my testing in this video, P6 and P7 were basically the exact same result on RTX 2000, 3000, and 4000 GPUs, and competed with X264 VerySlow in quality.</p>



<p>While game streaming, I saw mostly the same performance recording as other GPUs in <em>Spider-Man Remastered</em> (though other games will see more benefits) with H.264, but then encoding with AV1&hellip; had negligible impact on game performance at all. It was virtually transparent. You wouldn&rsquo;t even know you were recording, even on the highest quality preset. I even had enough headroom to set OBS to an 8K canvas and upscale my 1440p game capture to 8k within OBS and record using the dual encoder chips, and still not see a significant impact.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375936" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/RTX-4090-Review-YouTube.mov_snapshot_15.55.552.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>Unfortunately, while Nvidia&rsquo;s Shadowplay feature does get 8K60 support on Lovelace via the dual encoders, only HEVC is supported at this time. Hopefully AV1 can be implemented&mdash;and supported for all resolutions, as HEVC only works for 8K or HDR as is&mdash;soon.</p>



<p>I also found that the GeForce RTX 4090 is now fast enough to do completely lossless 4:4:4 HEVC recording at 4K 60FPS&mdash;something prior generations simply cannot do. 4:4:4 chroma subsampling is important for maintaining text clarity and for keeping the image intact when zooming in on small elements like I do for videos, and at 4K it&rsquo;s kind of been a &ldquo;white whale&rdquo; of mine, as the throughput on RTX 2000/3000 hasn&rsquo;t been enough or the OBS implementation of 4:4:4 isn&rsquo;t optimized enough. Unfortunately 4:4:4 isn&rsquo;t possible in AV1 on these cards, at all.</p>



<h2><a></a>Photo editing</h2>



<p>Photo editing sees virtually zero improvement on the GeForce RTX 4090. There&rsquo;s a slight score increase on the Adobe Photoshop PugetBench tests versus previous generations, but nothing worth buying a new card over.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375931" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-photoshop.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375942" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/RTX-4090-Review-YouTube.mov_snapshot_06.49.496.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>Same goes for Lightroom Classic. Shame.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375937" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-Affinity.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>But if you&rsquo;re an Affinity Photo user, the RTX 4090 far outperforms other GPUs, I&rsquo;m not sure whether to interpret that Affinity is more or less optimized in this case.</p>
...
<p>AI is all the rage these days, and AI upscalers are in high demand right now. Theoretically, the GeForce RTX 4090&rsquo;s improved AI hardware would benefit these workflows&mdash;and we mostly see this ring true. The RTX 4090 tops the charts for fastest upscaling in Topaz Labs Video Enhance AI and Gigapixel, as well as ON1 Resize AI 2022.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375941" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-TopazLabs-VEAI.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375938" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/Topaz-Gigapixel.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>But Topaz&rsquo;s new PhotoAI app sees weirdly low performance in all Nvidia cards. I&rsquo;ve been told this may be a bug, but a fix has yet to be distributed.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375934" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-Topaz-PhotoAI.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>Using FlowFrames to AI interpolate 60FPS footage to 120FPS for slow-mo usage, the RTX 4090 sees a 20 percent speed-up compared to the RTX 4090. This is nice as it is, but I&rsquo;ve been told by users in the FlowFrames Discord server that this could theoretically scale more as optimizations for Lovelace are developed.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375928" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-flowframes.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>What about generating AI Art? I tested N00mkrad&rsquo;s Stable Diffusion GUI and found that the GeForce RTX 4090 blew away all previous GPUs in both half and full-precision generation&mdash;and once again have been told the results &ldquo;should be&rdquo; higher, even. Exciting times.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375932" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-Stable-Diffusion.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<h2><a></a>3D rendering</h2>



<p>Alright, the bold &ldquo;2X Faster&rdquo; claims are here. I wanted to test 3D workflows on my Threadripper Pro rig, since I&rsquo;ve been getting more and more into these new tools in 2022.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375920" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-blender-monster.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375921" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-blender-junkshop.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>Testing Blender, both the Monster and Classroom benchmark scenes have the RTX 4090 rendering twice as fast as the RTX 3090, with the Junkshop scene rendering just shy of 2X faster.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375943" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-blender-classroom.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>This translates not only to faster final renders&mdash;which at scale is absolutely massive&mdash;but a <em>much</em> smoother creative process as all of the actual preview/viewport work will be more fluid and responsive, too, and you can more easily preview the final results without waiting forever.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375940" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-octane.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>Benchmarking Octane&mdash;a renderer used by 3D artists and VFX creators in Cinema4D, Blender, and Unity&mdash;again has the RTX 4090 running twice as fast as the RTX 3090.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="RTX 4090 content creation performance" class="wp-image-1375933" height="675" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/4090-vray.png?w=1200" width="1200" /></figure><p class="imageCredit">Adam Taylor/IDG</p></div>



<p>&hellip;and again, the same goes for V-Ray in both CUDA and RTX workflows.</p>



<h2 id="bottom-line-the-geforce-rtx-4090-offers-outstanding-value-to-content-creators">Bottom line: The GeForce RTX 4090 offers outstanding value to content creators</h2>



<p>That&rsquo;s where the value is. The Titan RTX was $2,500, and it was already phenomenal to get that performance for $1,500 with the RTX 3090. Now for $100 more, the <a href="https://www.pcworld.com/article/1348123/nvidia-geforce-rtx-4090-review-ada-lovelace.html">GeForce RTX 4090</a> runs laps around prior GPUs in ways that have truly game-changing impacts on workflows for creators of all kinds.</p>



<p>This might explain why the formerly-known-as-Quadro line of cards got far less emphasis over the past few years, too. Why buy a $5,000+ graphics card when you can get the same performance (or more, Quadros were never super fast, they just had lots of VRAM) for $1,600?</p>



<figure class="wp-block-embed is-type-video is-provider-youtube wp-block-embed-youtube wp-embed-aspect-16-9 wp-has-aspect-ratio"><div class="wp-block-embed__wrapper">

</div></figure><p>Obviously the pricing of the $1,200 RTX 4080 and <a href="https://www.pcworld.com/article/1354391/nvidia-cancels-the-controversial-rtx-4080-12gb.html">recently un-launched $899 4080 12GB</a> can still be concerning until we see independent testing numbers, but the GeForce RTX 4090 might just be the first time marketing has boasted of &ldquo;2x faster&rdquo; performance on a product and I feel like I&rsquo;ve actually received that promise. Especially for results within my niche work interests instead of mainstream tools or gaming? This is awesome.</p>



<p>Pure gamers probably shouldn&rsquo;t spend $1,600 on a graphics card, unless feeding a high refresh rate 4K monitor with no compromises is a goal. But if you&rsquo;re interested in getting real, nitty-gritty content creation work done <em>fast</em>, the GeForce RTX 4090 can&rsquo;t be beat&mdash;and it&rsquo;ll make you grin from ear to ear during any late-night <em>Call of Duty </em>sessions you hop into, as well. &nbsp;</p>
...
<div><div class="review-columns"><div class="review-column"><h3 class="review-subTitle" id="pros">Pros</h3><ul class="pros review-list"><li>Slick two-tone colorway and improved grips</li><li>Integrated rechargeable battery</li><li>USB-C and Bluetooth provide broad compatibility</li><li>Customizable profiles</li></ul></div><div class="review-column"><h3 class="review-subTitle" id="cons">Cons</h3><ul class="cons review-list"><li>Rear button slots go unused without the $60 accessory kit</li><li>More than twice the price of standard Xbox controller</li></ul></div></div></div><h3 class="review-subTitle review-subTitle--borderTop" id="our-verdict">Our Verdict</h3><p class="verdict">The Elite Controller Series 2 Core is a major functionality upgrade over the base model Xbox controller, but most &ldquo;elite&rdquo; gamers will want the accessories to complete the experience.</p>
</div>
				<h3 class="review-best-price" id="best-prices-today-xbox-elite-controller-series-2-core">
			Best Prices Today: Xbox Elite Controller Series 2 Core		</h3>
			...
			<div class="price-comparison__record price-comparison__record--header">
				...
				<div class="price-comparison__price">
					<span>Price</span>
							...
							<div>
								<a class="price-comparison__view-button" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.amazon.com/dp/B0B789CGGQ?tag=pcworld02-20&amp;linkCode=ogi&amp;th=1&amp;psc=1&amp;xcust=2-2-1367331-2-1367347-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">View Deal</a>							</div>
						</div>
															<div class="price-comparison__record">
							<div class="price-comparison__image">
							...
							<div>
								<a class="price-comparison__view-button" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.xbox.com/en-US/accessories/controllers/xbox-elite-wireless-controller-series-2-core&amp;xcust=2-2-1367331-2-1367347-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">View Deal</a>							</div>
						</div>
...
<p>Microsoft used to offer just one Xbox controller, leaving it to third parties to fill any specific niches, but no more. It launched the first Elite Controller in the Xbox One era, and it followed that up with the revamped <a href="https://www.pcworld.com/article/398272/xbox-elite-controller-series-2-review-more-of-the-same-but-better.html">Series 2 Elite controller</a> in 2019. However, at almost $200 it&rsquo;s pricey, and even dedicated gamers may scoff at the expense. Now, the Elite Controller Series 2 Core has entered the game. This controller has a few aesthetic changes from the standard Elite, and it doesn&rsquo;t come with the accessories kit, but it&rsquo;s priced at a more reasonable $130.&nbsp;</p>



<p>If you don&rsquo;t need all the add-ons, the Core is a great way to save some cash while getting a more feature-rich Xbox controller. But if you end up wanting the accessories, it will just cost you more in the long run. Still, this could be the sweet spot for some gamers.</p>



<h2 id="elite-controller-series-2-core-design-and-build-quality">Elite Controller Series 2 Core: Design and build quality</h2>



<p>Microsoft&rsquo;s Series 2 Core controller has the same shape and profile as the Series 2 Elite, which itself is almost identical to the <a href="https://www.pcworld.com/article/831843/xbox-wireless-controller-review.html">2020 base model controller</a> that ships with the Xbox Series S and Series X. If you&rsquo;re coming from the regular controller, as most will, the first thing you&rsquo;ll probably notice about the Series 2 Core is the rubberized grips. They feel much more secure in the hand than the all-plastic design of the standard Xbox gamepad, and the dot texture is present all the way around. The Elite Series 2 has the same texture, but the entire controller is black&mdash;the Core has a two-tone white/black colorway that we think looks pretty sharp.&nbsp;</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="Xbox Elite Controller Series 2 Core" class="wp-image-1367336" height="800" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/elite-core-2.jpg?quality=50&amp;strip=all&amp;w=1200" width="1200" /><figcaption><p>The Xbox Elite Controller Series 2 Core has rubberized grips that feel much more secure than the plastic of the standard controllers.</p></figcaption></figure><p class="imageCredit">Ryan Whitwam</p></div>



<p>The top edge sports the USB-C port for charging and wired gameplay, along with the pairing button. It comes with an 8-foot USB-A-to-C cable, too. One thing you won&rsquo;t see is a seam for the battery compartment. Unlike the base model, this controller has an integrated rechargeable battery. Previously, you had to go all the way up to the $180 Elite Series 2 for that luxury. Look farther down on the back, and you&rsquo;ll understand why the Series 2 Core is only $130.&nbsp;</p>
		...
		<div class="wp-block-product-widget-block product-widget is-half-width is-float-right">
			...
			<div class="product-widget__content-wrapper">
						...
						<h3 class="product-widget__title" id="xbox-wireless-controller-2020">Xbox Wireless Controller (2020)</h3>
									...
									<div class="product-widget__image-outer-wrapper">
						<div class="product-widget__image-wrapper">
							<img alt="Xbox Wireless Controller (2020)" class="product-widget__image" height="1333" src="https://b2c-contenthub.com/wp-content/uploads/2022/08/xbox-wireless-controller-2.jpg?quality=50&amp;strip=all" width="2000" /></div>
					</div>
				...
				<div class="product-widget__information">
									...
									Best Prices Today:
														...
														<span class="product-widget__pricing-details--links-wrapper">
								<a class="product-widget__pricing-details--link" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.amazon.com/dp/B08DF248LD?tag=pcworld02-20&amp;linkCode=ogi&amp;th=1&amp;psc=1&amp;xcust=2-2-1367331-5-831856-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">$49.00 at  Amazon</a>											<span class="amp-bar"> | </span>
																		<a class="product-widget__pricing-details--link" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://adorama.rfvk.net/c/321564/29622/1036?prodsku=XB1V800001&amp;u=https%3A%2F%2Fwww.adorama.com%2FXB1V800001.html&amp;intsrc=CATF_230&amp;xcust=2-2-1367331-5-831856-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">$59.99 at  Adorama</a>											<span class="amp-bar"> | </span>
																		<a class="product-widget__pricing-details--link" href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.xbox.com/en-US/accessories/controllers/xbox-wireless-controller&amp;xcust=2-2-1367331-5-831856-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow" target="_blank">$59.99 at  Microsoft</a>							</span>
						</div>
									</div>
			</div>
		</div>
...
<p>The Core doesn&rsquo;t include Microsoft&rsquo;s accessory package, but the controller is fully compatible with it. Thus, you have four slots for rear paddle buttons. Not having them makes the controller look a bit incomplete, but admittedly, you&rsquo;re not going to spend a lot of time staring at the back of your gamepad. Also on the back are switches to change the travel of the triggers. That&rsquo;s useful if you want to tune the experience for specific games. For example, you might want the short throw for shooters, but the longer travel is ideal for racing games where the trigger is your throttle. The switches are a bit fiddly and hard to adjust on the fly, though.&nbsp;</p>



<p>On the face of the controller, you&rsquo;ll find all the buttons in the usual Xbox layout. The ABXY cluster doesn&rsquo;t have the color-coding of the cheaper controller, which makes for a more understated look. There&rsquo;s also an LED profile indicator in the middle. The d-pad has the same metal dish shape as the full-priced Elite Series 2, which feels nicer under your finger than even the improved plastic d-pad on the regular model. The Core has the same removable controls as the non-Core Elite gamepad, too. Both the d-pad and thumbsticks are held in place with magnets, and they feel completely stable&mdash;no wobble or clicking&mdash;until you pull straight up. Since the Core doesn&rsquo;t come with the accessory bundle, you&rsquo;ll probably leave these in place.</p>



<h2 id="elite-controller-series-2-core-features-and-hands-on-experience">Elite Controller Series 2 Core: Features and hands-on experience</h2>



<p>If you&rsquo;re switching from the standard Xbox controller, you&rsquo;ll notice the added heft of the Elite Core. It&rsquo;s 300 grams (10.58 ounces), whereas the regular controller (with batteries installed) is 250g. The balance of the controller is still good, though, and we found it perfectly comfortable for long gaming sessions. The adjustable triggers also help to limit unnecessary movement as most games don&rsquo;t need the full range of motion.&nbsp;</p>



<p>Because it does so much more, the Elite Core needs firmware updates. In fact, it won&rsquo;t work correctly out of the box until you update it. On Windows, you&rsquo;ll need to download the Xbox accessories app, but the Xbox console will already know how to update your peripherals.</p>



<p>Microsoft says the controller can run about 40 hours wirelessly on a charge, and that&rsquo;s only a tiny bit higher than our real-world numbers. It runs long enough you might lose track of the cable, but happily, it charges with standard USB-C. There are pogo pins on the back for the controller charging dock, but that&rsquo;s an unnecessary add-on when USB-C is so prevalent.&nbsp;</p>



<p>All the buttons on the Elite Controller Series 2 Core are smooth and appropriately tactile. The sound is a bit quieter and deeper than the standard controller, save for the triggers, which are much louder if you use the middle or short travel positions. We&rsquo;re impressed that the thumbsticks feel so solid even when you&rsquo;re spinning them furiously&mdash;you&rsquo;d never know they pop off unless you pull upward on them.&nbsp;</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="Xbox Elite Controller Series 2 Core" class="wp-image-1367338" height="800" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/elite-core-3.jpg?quality=50&amp;strip=all&amp;w=1200" width="1200" /><figcaption><p>The thumbsticks on the Xbox Elite Controller Series 2 Core feel surprisingly solid considering they are removable.</p>
</figcaption></figure><p class="imageCredit">Ryan Whitwam</p></div>



<p>The cheaper 2020 controller added a share button in the middle of the face, but the Elite Core has a lot more going on. The button in that position lets you switch between the controller&rsquo;s three customizable profiles, as indicated with the aforementioned profile LED indicator. The profiles let you control what each button does, adjust your trigger dead zones, tweak the vibration, invert the thumbsticks, and even change the Xbox button&rsquo;s color.&nbsp;</p>



<p>The Elite Core has even more functionality if you need it. You can assign a button to &ldquo;shift,&rdquo; which activates secondary functions for any button of your choosing. So you lose instant access to the share feature, but this is a very powerful upgrade over the base model controller. However, you might not have a button to devote to shift unless you splurge on the accessory kit to get the paddles.&nbsp;</p>



<p>You do miss out on some of the controller&rsquo;s functionality by not having the accessory kit, which Microsoft will sell you separately for $60. That puts the total price slightly higher than if you&rsquo;d just bought the non-Core Elite controller, which comes with the kit.</p>
		...
		<div class="wp-block-product-widget-block product-widget is-half-width">
			...
			<div class="product-widget__content-wrapper">
									<div class="product-widget__title-wrapper">
						<h3 class="product-widget__title" id="xbox-elite-wireless-controller-series-2">Xbox Elite Wireless Controller Series 2</h3>
					</div>
				
									<div class="product-widget__image-outer-wrapper">
						<div class="product-widget__image-wrapper">
							<img alt="Xbox Elite Wireless Controller Series 2" class="product-widget__image" src="https://m.media-amazon.com/images/I/41xqtrfjZSL.jpg?quality=50&amp;strip=all" /></div>
					</div>
						...
						<img alt="Editors' Choice" class="product-widget__review-details--editors-choice-logo" src="https://www.pcworld.com/wp-content/uploads/2021/09/PC-ED-CHOICE.png" /><div class="product-widget__rating-and-review-link">
								<div class="product-widget__review-details--rating">
											<div class="starRating"></div>
										</div>									<a class="product-widget__review-link" href="https://www.pcworld.com/article/398272/xbox-elite-controller-series-2-review-more-of-the-same-but-better.html" target="_blank">Read our review</a>
...
<h2 id="elite-controller-series-2-core-compatibility">Elite Controller Series 2 Core: Compatibility</h2>



<p>The Elite Core gamepad pairs perfectly with the Xbox Series X and S, but its Bluetooth functionality means it can also talk to myriad other devices. To pair with other devices over Bluetooth, long-press the pair button next to the USB-C port and select it on your phone or PC. A double-tap of that button will move the controller back to the Xbox, if it&rsquo;s paired with one.</p>



<p>Microsoft&rsquo;s Windows OS naturally has full integration, including the <a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://apps.microsoft.com/store/detail/xbox-accessories/9NBLGGH30XJ3&amp;xcust=2-2-1367331-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">Xbox Accessories app</a> for conjuring the controller&rsquo;s advanced features. You can also connect it to an Android or iOS mobile device over Bluetooth, but you&rsquo;ll have to use the desktop app and a USB-C cable to change settings.&nbsp;</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="Xbox Elite Controller Series 2 Core" class="wp-image-1367340" height="800" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/elite-core-4.jpg?quality=50&amp;strip=all&amp;w=1200" width="1200" /></figure><p class="imageCredit">Ryan Whitwam</p></div>



<p>Speaking of the USB-C port, that&rsquo;s another way you can connect to the controller. It works in wired mode for PC and Xbox. While we had no trouble using the base model Xbox controller in wired mode with Android, that&rsquo;s not the case for the Elite Core. For whatever reason, it will only charge when connected to a phone&rsquo;s USB-C port.</p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image size-large"><img alt="Xbox Elite Controller Series 2 Core" class="wp-image-1367341" height="800" src="https://b2c-contenthub.com/wp-content/uploads/2022/11/elite-core-5.jpg?quality=50&amp;strip=all&amp;w=1200" width="1200" /><figcaption><p>Xbox Elite Controller Series 2 Core with its charging cable.</p>
</figcaption></figure><p class="imageCredit">Ryan Whitwam</p></div>



<h2 id="should-you-buy-an-elite-controller-series-2-core">Should you buy an Elite Controller Series 2 Core?</h2>



<p>The Elite Controller Series 2 Core adds a ton of features you don&rsquo;t get with Microsoft&rsquo;s standard controller, including profiles, better grips, button remapping, and adjustable triggers. However, you lose out on some of what the hardware <em>can </em>do by not getting the bundled accessory kit, which comes with the full-priced Elite Series 2 kit. The rear-facing paddle button connectors are useless unless you spend more on accessories, and it&rsquo;s pointless to have removable buttons when you don&rsquo;t have the alternative controls.&nbsp;</p>



<p>For mobile and PC gamers, the Elite Core does offer a better experience than the base model gamepad. The built-in battery means you can take the Elite Core controller on the road and charge it with a regular USB-C cable, but you might not even have to bother given the robust battery life. However, the lack of wired USB-C support on smartphones is a bummer.&nbsp;</p>



<p>For casual gamers who don&rsquo;t want button profiles or adjustable triggers, it&rsquo;s best to stick with the cheaper Xbox controller. Serious gamers should probably still spring for the full Elite controller kit. It&rsquo;s more expensive, but you get all the accessories you might end up buying anyway. Buying the Elite Core and the accessory kit separately is $10 more than just buying the full Elite bundle. For those few in the middle, the Elite Core is a great piece of hardware. The $130 asking price is steep but justifiable as long as you are confident you won&rsquo;t want the accessories after you start tinkering with the Elite Controller Series 2 Core.</p>
...
<p>With the deal, you&rsquo;re bundling three separate subscriptions to PS Plus Essential, and they&rsquo;re stackable. That means you can combine all of them for your own three-year membership or spread them out among your&nbsp;<em>Rocket League</em>&nbsp;teammates and squad up for a year.</p>



<p>But let&rsquo;s back up for those that might be new to Playstation, or to the&nbsp;<a href="https://www.pcworld.com/article/627205/sony-reveals-its-game-pass-alternative-and-microsoft-has-nothing-to-worry-about.html" rel="noreferrer noopener" target="_blank">new tiered membership system</a>&nbsp;for PS Plus that debuted this year. Right now, players can take their pick of three membership levels. PS Plus Essential is the opening tier, and as the name implies, it is indeed essential &ndash; at least if you plan on playing online. Your membership opens up access to online play on PS 4 or 5 against a global community of gamers on multiplayer hits like&nbsp;<em>FIFA 22</em>&nbsp;or the&nbsp;<em>Call of Duty</em>&nbsp;series.</p>



<p>But that&rsquo;s just the start of the perks. Essential members get access to exclusive discounts and pre-order options for some of the hottest upcoming titles, plus game tips and special upgrades. Best of all, you get free games every month, yours to keep &ndash; plus 100GB of cloud storage to keep them with.</p>



<p>Once again, this bundle gives players&nbsp;<a href="https://shop.pcworld.com/sales/playstation-plus-essential-3-yr-subscription-code-bundle?utm_source=pcworld.com&amp;utm_medium=referral&amp;utm_campaign=playstation-plus-essential-3-yr-subscription-code-bundle&amp;utm_term=scsf-555329&amp;utm_content=a0x1P000004lqdyQAA&amp;scsonar=1" rel="noreferrer noopener" target="_blank">3 codes for a one-year subscription to PS Plus Essential</a>, all for $169.99 &ndash; a 5% discount off the $179 MSRP.</p>



<p><a href="https://shop.pcworld.com/sales/playstation-plus-essential-3-yr-subscription-code-bundle?utm_source=pcworld.com&amp;utm_medium=referral-cta&amp;utm_campaign=playstation-plus-essential-3-yr-subscription-code-bundle&amp;utm_term=scsf-555329&amp;utm_content=a0x1P000004lqdyQAA&amp;scsonar=1" rel="noreferrer noopener" target="_blank">&nbsp;</a></p>


<div class="extendedBlock-wrapper block-coreImage undefined"><figure class="wp-block-image"><img alt="" src="https://cdnp2.stackassets.com/0a4d7f3a1eae3b7e1cb9d554cf381f8a0eb9324f/store/e17ea1327f13b97f92ffbc35c254c66678fc72622d63ec242a1d8d8e4431/sale_315878_primary_image.jpg" /></figure></div>



<p><strong>PlayStation Plus Essential: 3-Yr Subscription Code Bundle &ndash; $169.99</strong></p>
...
<p>Chromebook sales have plunged in the days since students snapped them up during the pandemic. That means Chromebook makers are relatively desperate to unload inventory, as our <a href="https://www.pcworld.com/article/796384/prime-day-chromebook-deals-oct-11.html">October Prime Day Chromebook deals</a> revealed. Suddenly, <em>good</em> Chromebooks went on sale. And you can expect more of the same in the days leading up to Black Friday.</p>
...
<ul><li><a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.target.com/p/lenovo-15-6-34-touchscreen-ideapad-3-chromebook-with-chrome-os-intel-processor-4gb-ram-memory-128gb-storage-gray-82n4002sus/-/A-86976510&amp;xcust=2-2-1374542-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">Lenovo IdeaPad 3 Chromebook</a> (Intel Pentium Silver N6000, 4GB RAM, 128GB SSD, 15.6-inch 1080p touch display): $249.99 (47% off at Target)</li><li><a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.amazon.com/ASUS-Chromebook-Touchscreen-Processor-C433TA-AS384T/dp/B08ZLF99VD/&amp;xcust=2-2-1374542-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">Asus Chromebook Flip C433</a> (Intel Core m3-8100Y, 8GB RAM, 64GB SSD, 14-inch 1080p display): $260.00 (35% off at Amazon)</li><li><a href="https://bestbuy.7tiv.net/c/321564/614286/10014?u=https://www.bestbuy.com/site/asus-14-chromebook-intel-core-m3-8100y-4gb-memory-64gb-emmc-silver/6513085.p&amp;subid1=2-2-1374542-1-0-0" rel="nofollow">Asus 14-inch Chromebook</a> (Intel Core m3-8100Y, 4GB RAM, 64GB SSD, 14-inch 1080p display) $179.00 (45% off at Best Buy)</li><li><a href="https://bestbuy.7tiv.net/c/321564/614286/10014?u=https://www.bestbuy.com/site/acer-acer-chromebook-317-laptop-17-3-fhd-ips-touch-display-intel-pentium-silver-n6000-processor-8gb-lpddr4x-64gb-emmc-wifi6/6470349.p?&amp;subid1=2-2-1374542-1-0-0" rel="nofollow">Acer Chromebook 317</a> (Intel Pentium Silver N6000, 8GB RAM, 64GB SSD, 17.3-inch 1080p touch display), $319.00 (36% off at Best Buy)</li><li><a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.walmart.com/ip/Lenovo-CB-3-14-with-Headset-Bundle-Celeron-N4020-4G-RAM-64G-eMMC-Chrome-OS-Gray-82C1002AUS/699229913&amp;xcust=2-2-1374542-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">Lenovo Chromebook 3 w/Headset </a>(Celeron N4020, 4GB RAM, 64GB SSD, 14-inch 768p display), $125.00 at Walmart</li><li><a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://www.amazon.com/HP-Chromebook-11-inch-Laptop-11a-na0010nr/dp/B08HJT1BKQ/&amp;xcust=2-2-1374542-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">HP Chromebook 11</a> (MediaTek MT8183, 4GB RAM, 32GB SSD, 11-inch 768p display): $119.00 (54% off at Amazon)</li></ul><p>The really outstanding deals are a bit skimpy, though both the IdeaPad 3 (which favors a larger screen) and the Asus Chromebook Flip (which improves performance via more memory) are pretty solid.</p>



<p>We&rsquo;d like to see Chromebooks with larger screens and more memory (such as the Acer Chromebook 317) go below $300, but $319 is still a pretty decent price. The HP Chromebook 11 deal is the absolute minimum you should buy in terms of specifications, but there&rsquo;s still a place for ultra-cheap Chromebooks, and that HP&rsquo;s price is the lowest it&rsquo;s been in a year.</p>
...
<div class="wp-block-idg-base-theme-faq-answer-block how-to-tip">
<p>We still expect low-end Chromebooks&mdash;say, those with a 768p screen, Intel Celeron processor, 4GB of RAM and 16GB of SSD storage&mdash;to be priced about $100. And if they get much below $100, they become essentially a stocking stuffer for most people.</p>



<p>That said, look for these specs in a <em>respectable </em>Chromebook: an Intel Celeron N4000 chip or higher, 8GB of RAM, and a 1080p screen. A Pentium Silver N6000 processor is a step up from that. A Core m3-8100Y <em>isn&rsquo;t</em>, but may still be satisfactory.</p>



<p>More memory (that is, 8GB rather 4GB of RAM) will allow for more browser tabs and a smoother browser experience. A 1080p screen will offer a comfortable laptop-like viewing experience. Onboard storage really doesn&rsquo;t matter all that much, though at least 32GB is preferable storing for apps, screenshots, and the like.</p>



<p>If you&rsquo;re familiar with our lengthy <a href="https://www.pcworld.com/article/402141/chromebooks-versus-windows-laptops-which-should-you-buy.html">laptops versus Chromebooks explainer</a>, you know that one of the potential gotchas is buying a Chromebook whose <a href="https://go.redirectingat.com/?id=111346X1569483&amp;url=https://support.google.com/chrome/a/answer/6220366?hl=en&amp;xcust=2-2-1374542-1-0-0&amp;sref=https://www.pcworld.com/feed" rel="nofollow">support window</a> expires soon. We try to factor that in, so you won&rsquo;t get stuck with a Chromebook that will lose support in the near future.</p>
</div>
</div></div>
