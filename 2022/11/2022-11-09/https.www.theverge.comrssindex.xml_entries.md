...
## Sports Story launches on the Switch next month
 - [https://www.theverge.com/2022/11/9/23449346/sports-story-nintendo-switch-indie-world-fall-showcase](https://www.theverge.com/2022/11/9/23449346/sports-story-nintendo-switch-indie-world-fall-showcase)
 - RSS feed: https://www.theverge.com/rss/index.xml
 - date published: 2022-11-09 20:14:32+00:00

<figure>
      <img alt="Graphic for Sports Story depicting a cartoon man engaged in several sports, like cricket, volleyball, and tennis." src="https://cdn.vox-cdn.com/thumbor/ZCho2f-GqC3DtBWP8G5NF8udMNM=/140x0:1660x1013/1310x873/cdn.vox-cdn.com/uploads/chorus_image/image/71606766/ezgif.com_gif_maker__12_.0.jpg" />
        <figcaption>Image: Nintendo</figcaption>
    </figure>

  <p id="K2c33N">Nintendo held its fall Indie World Showcase today showing off a number of titles primed to hit the Switch in the coming months (and some even later today). We got to see cozy Indian cooking with <em>Venba</em>, <em>Desta: The Memories Between</em> got its console debut, and the sequel to <em>Golf Story</em> finally got a release window. Here are the highlights from today’s presentation. </p>
<div id="6pwbud"><div style="width: 100%; height: 0; padding-bottom: 56.25%;"></div></div>
<h3 id="9oZsiB">
<em>Venba</em> — Spring 2023</h3>
<p id="CwL2T9">In <em>Venba</em>, an Indian immigrant family honors the traditions of their homeland by cooking mouthwatering dishes. Throughout the game, you’ll see the story of Venba and her family as they adjust to a new life in Canada in the 1980s. I can’t wait to play and snag some of these recipes for myself. </p>
<div id="zP7Kcy"><div style="width: 100%; height: 0; padding-bottom: 56.25%;"></div></div>
<h3 id="z9qxNy">
<em>Goodbye World</em> — November 2022</h3>
<p id="QbyHhy">If you ever wanted to know the...</p>
  <p>
    <a href="https://www.theverge.com/2022/11/9/23449346/sports-story-nintendo-switch-indie-world-fall-showcase">Continue reading&hellip;</a>
  </p>

## Now Google Home users can sign up to test the redesigned app
 - [https://www.theverge.com/2022/11/9/23449215/google-home-app-public-preview](https://www.theverge.com/2022/11/9/23449215/google-home-app-public-preview)
 - RSS feed: https://www.theverge.com/rss/index.xml
 - date published: 2022-11-09 20:13:10+00:00

<figure>
      <img alt="Google logo" src="https://cdn.vox-cdn.com/thumbor/YvH48H16vFOWS5n4P84bjJJIhPw=/0x0:2040x1360/1310x873/cdn.vox-cdn.com/uploads/chorus_image/image/71606760/STK093_Google_04.0.jpg" />
        <figcaption>Illustration: The Verge</figcaption>
    </figure>

  <p id="ODJFaN">The wait is over: some Google Home users <a href="https://support.google.com/googlenest/answer/12494697?hl=en#:~:text=Public%20Preview%20is%20a%20program,to%20join%20the%20Public%20Preview">can finally try out</a> the newly redesigned Google Home app. If you want to try out the new Google Home app public preview, you might be able to easily sign up inside the app itself.</p>
<p id="q5lBbG">To get started, you’ll request an invite within the Google Home app for Android and iOS, which takes a couple of steps, as we’ve outlined below. It’s also not an immediate process, either, as some people have had to wait a while to be accepted, so be prepared to wait.</p>
<ol>
<li id="8eZV0K">Assuming the preview is available to you, first head on over to Google Home’s<strong> Settings menu</strong>.</li>
<li id="toysUM">There, you’ll be able to see <strong>Public Preview</strong> under <strong>General</strong>.</li>
<li id="PE0Hhz">You can then <strong>click </strong>on <strong>Request invite </strong>to try out the preview.</li>
</ol>
  <figure class="e-image">
...
<figure>
  ...
  <figure class="e-image">
      ...
      <figcaption><em>A screenshot taken from the now-unlisted video originally posted on the Amazon YouTube page.</em></figcaption>
  </figure>
...
<figure>
  ...
  <p id="faCPCs">Software developer Serif has launched V2 of its Affinity creative suite, bringing new features and enhancements to its trio of graphic design and content creation applications that undercut Adobe on price.</p>
