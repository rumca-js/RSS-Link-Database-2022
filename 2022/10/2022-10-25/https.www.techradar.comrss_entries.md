...
Wyze's upcoming Cam v3 Pro can shoot 2K resolution video and has new features that enhance processing speed.
...
Almost a quarter of all phishing attempts impersonate DHL, with Microsoft and LinkedIn also popular.
...
The BBC is joining forces with Disney to release future seasons of Doctor Who on Disney Plus outside of the UK.
...
Passkey login is now available for PayPal users in the US with an iPhone - with more countries to follow soon.

## Intel Raptor Lake CPU surprise gets ruined by Microsoft
 - [https://www.techradar.com/news/intel-raptor-lake-cpu-surprise-gets-ruined-by-microsoft/](https://www.techradar.com/news/intel-raptor-lake-cpu-surprise-gets-ruined-by-microsoft/)
 - RSS feed: https://www.techradar.com/rss
 - date published: 2022-10-25 12:00:14+00:00
 - tags: None
...
## Apple explains what 'Clean Charging' is for iOS 16.1 - but it's US only for now
 - [https://www.techradar.com/news/apple-explains-what-clean-charging-is-for-ios-161-but-its-us-only-for-now/](https://www.techradar.com/news/apple-explains-what-clean-charging-is-for-ios-161-but-its-us-only-for-now/)
 - RSS feed: https://www.techradar.com/rss
 - date published: 2022-10-25 11:02:06+00:00
 - tags: None

With the release of iOS 16.1, Apple has clarified just what clean energy charging entails for US users.

## Dead Space remake devs followed the lead Capcom set with Resident Evil 4
 - [https://www.techradar.com/news/dead-space-remake-devs-followed-the-lead-capcom-set-with-resident-evil-4/](https://www.techradar.com/news/dead-space-remake-devs-followed-the-lead-capcom-set-with-resident-evil-4/)
 - RSS feed: https://www.techradar.com/rss
 - date published: 2022-10-25 10:54:34+00:00
 - tags: None

<article>
                                <p>The EA Motive Studio developers behind the Dead Space remake quickly found that taking on experimental projects isn’t for the faint of heart. </p><p>Before the <a href="https://www.techradar.com/news/dead-space-remake"><u>Dead Space remake</u></a>, EA Motive worked on a lesser-known ambitious project called Gaia. Sadly, after six years of development, the project was scrapped. The team "didn’t want to bite off more than we could chew," EA Motive general manager Patrick Klaus told <a href="https://www.eurogamer.net/ea-motive-boss-cancellations-in-video-game-development-shouldnt-be-a-taboo-thing" target="_blank">Eurogamer</a>. </p><p>It turned out that the risk associated with such an ambitious project was too much for the relatively young studio to handle. “Considering you&apos;ve got families... you want to make sure you&apos;ve got sustainability, and you set the teams up for success,” Klaus said. “I take that responsibility of calculated risk-taking very seriously."</p><p>Instead of Gaia, EA Motive began work on the much-anticipated Dead Space remake, along with prospects of working on a future Iron Man game. So it wasn’t necessarily a step backwards for the studio. </p>
<h2 id="back-to-the-drawing-board-xa0-4">Back to the drawing board  </h2>
<p>EA Motive isn’t the first developer to return to the drawing board when developing a game, and it likely won’t be the last. Capcom’s Resident Evil 4 is a great example of this. The iconic survival horror game had gone through massive reworking before its release in 2005. </p><p>Resident Evil 4 had three separate prototypes throughout development. These were ‘Fog’, ‘Hallucinations’, and ‘Hook man’, with the last prototype showcased at E3 in 2003. Unfortunately, each one of these ideas was inevitably scrapped by Capcom.</p><p>But that’s not where the story ended. After returning to the drawing board, Capcom repurposed much of the ‘Fog’ prototype. Initially meant to be a radical departure from the Resident Evil franchise, the prototype became the first Devil May Cry game.</p>
<figure class="van-image-figure  inline-layout"><div class="image-full-width-wrapper"><div class="image-widthsetter"><p class="vanilla-image-block" style="padding-top: 56.25%;"><img align="middle" alt="A character standing in a big hall" class="" height="1080" id="o633A3R6PqQLLXi8iTfFPf" name="Devil_May_Cry_Switch_Screens02.jpg" src="https://cdn.mos.cms.futurecdn.net/o633A3R6PqQLLXi8iTfFPf.jpg" width="1920" /></p></div></div><figcaption class=" inline-layout"><span class="credit">(Image credit: Capcom)</span></figcaption></figure>
<h2 id="good-news-xa0-4">Good news  </h2>
<p>Both Capcom and EA Motive prove that starting again doesn’t have to be a failure. "Cancellations in video game development shouldn&apos;t be a taboo thing," Klaus said.  “It&apos;s part of the creative process”.</p><p>Often, it allows developers to improve on existing ideas and get better with time. “Dead Space was the first thing in order for us to step up and have more ambition,” Klaus said, “and then with Iron Man, we&apos;ve got the opportunity to take things to a whole new level".</p><p>There are going to be many pressures on a studio through a game&apos;s development – budget and time available, in particular. But when a team realizes it is going down a path with a project that won&apos;t end in something it can stand behind, having the freedom and space to start again, can lead to wonderful games.</p>
...
The GoPro Hero 11 Black Mini has been delayed, but the compact action cam will still be available to buy in November.
